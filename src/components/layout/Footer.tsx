...
import { Repeat, Twitter, Github, Linkedin, Instagram } from 'lucide-react';

const footerLinks = {
  product: [
    { label: 'How It Works', href: '/#how-it-works' },
    { label: 'Browse Skills', href: '/search' },
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Exchange skills, build community. Learn new things by teaching what you know.
            </p>
            {/* Social Links */}
